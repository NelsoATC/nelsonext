          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Link href="/madrid" className="text-primary hover:text-primary/80 text-sm flex items-center transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <Link href="/canarias" className="text-primary hover:text-primary/80 text-sm flex items-center transition-colors">
                  {isSpanish ? "Ver instalaciones" : "View facilities"}
                </Link>
              </div>
            </div>
